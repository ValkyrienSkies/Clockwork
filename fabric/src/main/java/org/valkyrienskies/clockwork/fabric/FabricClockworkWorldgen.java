...
public class FabricClockworkWorldgen {
    ...
    public static final ResourceKey<PlacedFeature>
            WANDERLITE_ORE = ResourceKey.create(Registry.PLACED_FEATURE_REGISTRY, ClockworkMod.asResource("ore_wanderlite"));


    public static void bootstrap() {
        Registry.register(BuiltinRegistries.CONFIGURED_FEATURE,
                ClockworkMod.asResource("ore_wanderlite"), WANDERLITE_ORE_CONFIGURED_FEATURE);

        Registry.register(BuiltinRegistries.PLACED_FEATURE, ClockworkMod.asResource("ore_wanderlite"),
                WANDERLITE_ORE_PLACED_FEATURE);
