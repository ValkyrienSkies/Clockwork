...
import org.valkyrienskies.clockwork.fabric.content.curiosities.tools.bluperglue.BluperGlueEffectPacket;
import org.valkyrienskies.clockwork.fabric.content.curiosities.tools.bluperglue.BluperGlueRemovalPacket;
import org.valkyrienskies.clockwork.fabric.content.curiosities.tools.bluperglue.BluperGlueSelectionPacket;
...
public enum FabricClockworkPackets {
    ...
    <T extends SimplePacketBase> FabricClockworkPackets(Class<T> type, Function<FriendlyByteBuf, T> factory,
    ...
    public static void registerPackets() {
        ...
        int id = 0;
        for (FabricClockworkPackets packet : values()) {
