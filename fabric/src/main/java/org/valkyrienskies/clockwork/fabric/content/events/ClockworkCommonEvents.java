...
import org.valkyrienskies.clockwork.fabric.content.commands.AllClockworkCommands;
...
public class ClockworkCommonEvents {
    ...
    public static void register () {
        ...
        CommandRegistrationCallback.EVENT.register(ClockworkCommonEvents::registerCommands);
    }
