...
public class AllClockworkConfigs {
    ...
    public static void init() {
        ...
        for (Map.Entry<ModConfig.Type, ConfigBase> pair : CONFIGS.entrySet()) {
            //TODO ModLoadingContext.registerConfig(ClockworkMod.MOD_ID, pair.getKey(), pair.getValue().specification);
        }


        BlockStressValues.registerProvider(ClockworkMod.MOD_ID, SERVER.kinetics.stressValues);

        //TODO ModConfigEvent.LOADING.register(AllClockworkConfigs::onLoad);
