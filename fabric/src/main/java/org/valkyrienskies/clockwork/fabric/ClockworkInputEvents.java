...
class ClockworkInputEvents {
    ...
    public static boolean onMouseScrolled(double deltaX, double delta) {
            ...
            var cancelled = (ClockworkMod.GRAVITRON_HANDLER.mouseScrolled(delta));
            return cancelled;
        }
    ...
    public static boolean onMouseInput(int button, int modifiers, MouseInputEvents.Action action) {
            ...
            if (ClockworkMod.GRAVITRON_HANDLER.onMouseInput(button, pressed)) return true;
            return false;
        }
}