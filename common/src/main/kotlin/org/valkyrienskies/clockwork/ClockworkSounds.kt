...
object ClockworkSounds {
    ...
    val PHYSICS_INFUSER_FINISH = create("physics_infuser_finish").subtitle("Physics Infuser infuses")
        ...
        .build()
    val WELDER_WELD = create("welder_weld").subtitle("Welder welds")
        .category(SoundSource.PLAYERS)
        .attenuationDistance(16)
        .build()
    val WELDER_WHIRR = create("welder_whirr").subtitle("Welder whirrs")
        .category(SoundSource.PLAYERS)
        .attenuationDistance(16)
        .build()
    val SUPERSONIC = create("supersonic").subtitle("Supersonic")
        ...
        .attenuationDistance(32)
        .build()
    val DESIGNATOR_ACTIVATE = create("designator_activate").subtitle("Designator activates")
        .category(SoundSource.PLAYERS)
        .attenuationDistance(16)
        .build()
    val DESIGNATOR_DUMP_CLUSTER = create("designator_dump_cluster").subtitle("Designator discharges")
        .category(SoundSource.PLAYERS)
        .attenuationDistance(16)
        .build()
    val DESIGNATOR_SELECT_START = create("designator_select_start").subtitle("Designator starts up")
        .category(SoundSource.PLAYERS)
        .attenuationDistance(16)
        .build()
    val DESIGNATOR_SELECT_END = create("designator_select_end").subtitle("Designator selects")
        .category(SoundSource.PLAYERS)
        .attenuationDistance(16)
        .build()
    val DESIGNATOR_IDLE = create("designator_idle").subtitle("Designator fizzles")
        .category(SoundSource.PLAYERS)
        .attenuationDistance(16)
        .build()
