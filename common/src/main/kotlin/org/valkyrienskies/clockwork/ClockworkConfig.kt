...
object ClockworkConfig {
    ...
    class Server {
        ...
        @ConfigEntry(description = "Multiplier applied to ship mass when yeeting (left-clicking) with the survival gravitron", min = 0.0, max = 500.0)
        var survivalGravitronYeetForce = 100.0
