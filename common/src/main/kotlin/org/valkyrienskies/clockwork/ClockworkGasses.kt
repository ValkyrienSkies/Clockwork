...
object ClockworkGasses {
    ...
    val PHLOGISTON = GasType("Phlogiston",ClockworkMod.asResource( "phlogiston"),  density = 3.0, viscosity = 2.0e-5, specificHeatCapacity = 14.30, thermalConductivity = 0.240, sutherlandConstant = 150.0, adiabaticIndex = 1.008, iconLocation = getIcon("phlogiston"))
    val HELIUM = GasType("Aether",ClockworkMod.asResource( "aether"),  density = 0.166, viscosity = 1.96e-5, specificHeatCapacity = 5.1832, thermalConductivity = 0.151, sutherlandConstant = 79.4, adiabaticIndex = 1.66, iconLocation = getIcon("aether"))
    val HYDROGEN = GasType("Stellane",ClockworkMod.asResource( "stellane"),  density = 0.08988, viscosity = 0.88e-5, specificHeatCapacity = 14.30, thermalConductivity = 0.18, sutherlandConstant = 72.0, adiabaticIndex = 1.4, iconLocation = getIcon("stellane"))
    val METHANE = GasType("Bog",ClockworkMod.asResource( "bog"),  density = 0.657, viscosity = 1.10e-5, specificHeatCapacity = 2.2, thermalConductivity = 0.031, sutherlandConstant = 90.0, adiabaticIndex = 16.0, iconLocation = getIcon("bog"))

    val VITIROL = GasType("Vitirol", ClockworkMod.asResource( "vitirol"), density = 2.2, viscosity = 2.0e-5, specificHeatCapacity = 8.0, thermalConductivity = 0.16, sutherlandConstant = 68.4, adiabaticIndex = 1.008, getIcon("vitirol"))
    val OZONITE = GasType("Ozonite", ClockworkMod.asResource( "ozonite"),  density = 1.15, viscosity = 0.78e-5, specificHeatCapacity = 0.92, thermalConductivity = 0.024, sutherlandConstant = 127.0, adiabaticIndex = 1.4, getIcon("ozonite"))
