...
class NewBearingController : ShipPhysicsListener {
    ...
    companion object {
        ...
        @OptIn(VsBeta::class)
        fun getOrCreate(ship: LoadedServerShip): NewBearingController {
            if (ship.getAttachment(NewBearingController::class.java) == null) {
                ship.setAttachment(NewBearingController())
            }
            return ship.getAttachment(NewBearingController::class.java)!!
        }
