...
class GravitronItemRenderer : CustomRenderedItemModelRenderer() {
    override fun render(
        ...
        val animation = getAnimationProgress(pt, leftHanded, mainHand)
    ...
    protected fun getAnimationProgress(pt: Float, leftHanded: Boolean, mainHand: Boolean): Float {
        val animation: Float = ClockworkClientEvents.GRAVITRON_HANDLER.getAnimation(mainHand xor leftHanded, pt)
        return Mth.clamp(animation * 5, 0f, 1f)
    }
