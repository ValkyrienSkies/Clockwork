...
object EaseHelper {
    ...
    fun easeInExpo(x: Float): Float {
        return if (x == 0f) 0f else Math.pow(2.0, (10 * x - 10).toDouble()).toFloat()
    }
    ...
    fun easeInOutExpo(x: Float): Float {
        return if (x == 0f) 0f else (if (x == 1f) 1 else if (x < 0.5) Math.pow(2.0, (20 * x - 10).toDouble()).toFloat() / 2 else (2 - Math.pow(2.0, (-20 * x + 10).toDouble()).toFloat()) / 2).toFloat()
    }
    ...
    fun easeOutOvershoot(x: Float): Float {
        val c1 = 1.70158
        val c3 = c1 + 1
        return (1 + c3 * Math.pow((x - 1).toDouble(), 3.0) + c1 * Math.pow((x - 1).toDouble(), 2.0)).toFloat()
    }
    ...
    fun easeInOutOvershoot(x: Float): Float {
        val c1 = 1.70158
        val c2 = c1 * 1.525
        return if (x < 0.5) (Math.pow(
            (2 * x).toDouble(),
            2.0
        ) * ((c2 + 1) * 2 * x - c2)).toFloat() / 2 else (Math.pow(
            (2 * x - 2).toDouble(),
            2.0
        ) * ((c2 + 1) * (x * 2 - 2) + c2) + 2).toFloat() / 2
    }
    ...
    fun easeOutElastic(x: Float): Float {
        ...
        return if (x == 0f) 0f else if (x == 1f) 1f else (Math.pow(
            2.0,
            (-10 * x).toDouble()
        ) * Math.sin((x * 10 - 0.75) * c4) + 1).toFloat()
    }

    //Elastic In/Out
    fun easeInOutElastic(x: Float): Float {
        val c5 = 2 * Math.PI / 4.5
        return if (x == 0f) 0f else if (x == 1f) 1f else if (x < 0.5) -(Math.pow(
            2.0,
            (20 * x - 10).toDouble()
        ) * Math.sin((20 * x - 11.125) * c5)).toFloat() / 2 else (Math.pow(
            2.0,
            (-20 * x + 10).toDouble()
        ) * Math.sin((20 * x - 11.125) * c5)).toFloat() / 2 + 1
    }
