...
object RenderUtil {
    ...
    fun renderCubeMatrix(
        ...
        renderAndTransform(crystal_inner, 1.5f, innerData.offset, innerData.rotation).light(light)
        ...
        renderAndTransform(crystal, 1.5f, data.offset, data.rotation).light(light).color(255, 255, 255, 255).overlay()
        ...
        renderAndTransform(crystal_outer, 1.5f, outerData.offset, outerData.rotation).light(light)
     ...
     * Transforms and renders a model
     */
    private fun renderAndTransform(
        buffer: SuperByteBuffer,
        scale: Float,
        coreOffset: Vector3f,
        coreRotation: Vector3f
    ): SuperByteBuffer {
        //Scale
        buffer.scale(scale)
