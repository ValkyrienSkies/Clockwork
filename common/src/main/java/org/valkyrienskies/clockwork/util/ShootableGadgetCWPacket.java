...
public abstract class ShootableGadgetCWPacket extends ShootGadgetPacket implements S2CCWPacket {

    public Vec3 location;
    public InteractionHand hand;
    public boolean self;

    public ShootableGadgetCWPacket(Vec3 location, InteractionHand hand, boolean self) {
    ...
    public ShootableGadgetCWPacket(FriendlyByteBuf buffer) {
        super(buffer);
