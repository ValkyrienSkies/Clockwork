...
public class RedstoneResistorRenderer extends KineticBlockEntityRenderer<RedstoneResistorBlockEntity> {
    ...
    @Override
    protected void renderSafe(RedstoneResistorBlockEntity te, float partialTicks, PoseStack ms, MultiBufferSource buffer,
        ...
        for (Direction direction : Iterate.directions) {
            ...
            SuperByteBuffer superByteBuffer =
                    CachedBufferer.partialFacing(AllPartialModels.SHAFT_HALF, te.getBlockState(), direction);
