package org.valkyrienskies.clockwork.forge.content.curiosities.tools.bluperglue;
...
import org.valkyrienskies.clockwork.content.curiosities.tools.bluperglue.*;
...
public class ForgeBluperGlueSelectionHandler {
    ...
    private Vec3 getTraceOrigin(Player playerIn) {
        ...
        double range = playerIn.getReachDistance() + 1;
    ...
    public void tick() {
        ...
        selected = null;
        if (firstPos == null) {
            double range = player.getReachDistance() + 1;
