...
import org.valkyrienskies.clockwork.integration.cc.CombustionEnginePeripheral;
...
public class ForgeCombustionEnginePeripheral extends CombustionEnginePeripheral {
    public ForgeCombustionEnginePeripheral(CombustionEngineBlockEntity engine) {
        super(engine);
    }
